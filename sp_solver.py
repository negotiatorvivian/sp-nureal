...
class randomKSAT(object):
    ...
    def __init__(self, N, M, max_iter, clause_mat, eps = 1e-3, verbose = False, use_cuda = True):
...
def get_sp_aggregate(clause_mat):
    ...
    prop = randomKSAT(N, M, max_iter = 1000, clause_mat = clause_mat, verbose = False)
    prop.warning_prop()
    prop.wid_localfield()
    ...
    #         edge_feature.append(2 * (prop.dgraph.adj[item][key]['delta'][0] - 0.5))
    # return edge_feature
